...
run_test "--speedup -2 (invalid)"       1 $default_ip --speedup -2
run_test "--speedup 0 (invalid)"        1 $default_ip --speedup 0
run_test "--ports 65536 (invalid)"      1 $default_ip --ports 65536
run_test "--ports -2 (invalid)"         1 $default_ip --ports -2
run_test "--ports 0 (invalid)"          1 $default_ip --ports 0
...
run_test "--scan (invalid) \"\""        1 $default_ip --scan ""
